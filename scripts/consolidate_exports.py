...
def generate_consolidated_exports() -> str:
    ...
    compat_lines = [
        ...
        "",
        "",
        "# FormatCategory was removed in rc.3; its values were inlined into",
        "# ListCreativeFormatsRequest as a narrower Type enum (audio, video, display, dooh).",
        "# This stub preserves imports for consumers that reference FormatCategory.",
        "class FormatCategory(str, _Enum):",
        "    audio = 'audio'",
        "    video = 'video'",
        "    display = 'display'",
        "    native = 'native'",
