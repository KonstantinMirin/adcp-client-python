...
class GeoProximity18(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime17 | None, Field(description="Travel time limit for isochrone calculation")
    ] = None
    transport_mode: Annotated[
...
class GeoProximity19(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime18 | None, Field(description="Travel time limit for isochrone calculation")
    ] = None
    transport_mode: Annotated[
        transport_mode_1.TransportMode | None,
        Field(
