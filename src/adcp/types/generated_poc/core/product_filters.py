...
class GeoProximity15(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime14 | None, Field(description='Travel time limit for isochrone calculation')
    ] = None
    transport_mode: Annotated[
...
class GeoProximity16(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime15 | None, Field(description='Travel time limit for isochrone calculation')
    ] = None
    transport_mode: Annotated[
        transport_mode_1.TransportMode | None,
        Field(
