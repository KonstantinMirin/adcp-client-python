...
from ..enums import adcp_domain, sort_direction, task_status
...
class Filters(AdCPBaseModel):
    ...
    domains: Annotated[
        list[adcp_domain.AdcpDomain] | None,
        Field(description='Filter by multiple AdCP domains', min_length=1),
    ] = None
    status: Annotated[
