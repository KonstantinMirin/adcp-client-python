...
class BuildCreativeRequest1(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    message: Annotated[
    ...
    target_format_ids: Any | None = None
    brand: Annotated[
...
class BuildCreativeRequest2(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    message: Annotated[
    ...
    target_format_id: Any | None = None
    target_format_ids: Annotated[
        list[format_id.FormatId],
        Field(
...
BuildCreativeRequest = BuildCreativeRequest1 | BuildCreativeRequest2
