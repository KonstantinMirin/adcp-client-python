...
class Details(AdCPBaseModel):
    ...
    protocol: Annotated[
        Protocol | None,
        Field(description="AdCP protocol where error occurred", title="AdCP Protocol"),
    ] = None
...
class TasksGetResponse(AdCPBaseModel):
    ...
    protocol: Annotated[
        Protocol, Field(description="AdCP protocol this task belongs to", title="AdCP Protocol")
    ]
