...
class Transport(AdCPBaseModel):
    ...
    type: Annotated[Type31, Field(description="Protocol transport type")]
...
class Endpoint(AdCPBaseModel):
    ...
    preferred: Annotated[
        Type31 | None, Field(description="Preferred transport when host supports multiple")
    ] = None
