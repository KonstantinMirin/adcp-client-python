...
class Forecast(AdCPBaseModel):
    ...
    method: Annotated[
        Method, Field(description='Method used to produce this forecast', title='Forecast Method')
    ]
    currency: Annotated[
        str,
        Field(
