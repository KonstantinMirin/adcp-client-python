...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit23, Field(description="Time unit.")]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit24, Field(description="Distance unit.", title="Distance Unit")]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type19, Field(description="GeoJSON geometry type.")]
...
class SignalId3(SignalId):
    pass


class SignalId4(SignalId2):
    pass
...
class SignalId5(SignalId):
    pass


class SignalId6(SignalId2):
    pass
...
class CreateMediaBuyResponse6(AdCPBaseModel):
    ...
    message: Annotated[
        str | None,
        Field(
            description="Optional human-readable explanation of why the task is submitted — e.g., 'Awaiting IO signature from sales team; typical turnaround 2–4 hours.' Suitable for display to buyer-side humans or agent reasoning."
        ),
    ] = None
    errors: Annotated[
        list[Error7] | None,
