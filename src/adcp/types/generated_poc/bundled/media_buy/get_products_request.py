...
class PreferredDeliveryType(Enum):
...
class SignalId10(SignalId):
    pass


class SignalId11(SignalId9):
    pass
...
class SignalId12(SignalId):
    pass


class SignalId13(SignalId9):
    pass
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit47, Field(description="Distance unit", title="Distance Unit")]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type39, Field(description="GeoJSON geometry type")]
...
class GeoProximity9(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime8 | None, Field(description="Travel time limit for isochrone calculation")
    ] = None
    transport_mode: Annotated[
        TransportMode | None,
        Field(
    ...
    radius: Annotated[Radius8, Field(description="Simple radius from the point")]
    geometry: Annotated[
        Geometry8 | None,
        Field(description="Pre-computed GeoJSON geometry defining the proximity boundary"),
    ] = None
...
class GeoProximity10(AdCPBaseModel):
    ...
    travel_time: Annotated[
        TravelTime9 | None, Field(description="Travel time limit for isochrone calculation")
    ] = None
    transport_mode: Annotated[
        TransportMode | None,
        Field(
    ...
    radius: Annotated[Radius9 | None, Field(description="Simple radius from the point")] = None
    geometry: Annotated[
        Geometry9,
        Field(description="Pre-computed GeoJSON geometry defining the proximity boundary"),
    ]
...
class GetProductsRequest(AdCPBaseModel):
    ...
    refine: Annotated[
        list[Refine | Refine4 | Refine5] | None,
        Field(
    ...
    preferred_delivery_types: Annotated[
        list[PreferredDeliveryType] | None,
        Field(
