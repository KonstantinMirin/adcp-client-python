...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit93, Field(description="Time unit.")]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit94, Field(description="Distance unit.", title="Distance Unit")]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type62, Field(description="GeoJSON geometry type.")]
