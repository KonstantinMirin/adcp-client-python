...
class Suppress10(Window):
    pass


class Window17(Window):
    pass
...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit77, Field(description='Time unit.')]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit78, Field(description='Distance unit.', title='Distance Unit')]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type59, Field(description='GeoJSON geometry type.')]
...
class RenderGuidance138(RenderGuidance):
    pass


class Jurisdiction146(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance139(RenderGuidance):
    pass


class Jurisdiction147(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance140(RenderGuidance):
    pass


class Jurisdiction148(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance141(RenderGuidance):
    pass


class Jurisdiction149(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance142(RenderGuidance):
    pass


class Jurisdiction150(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance143(RenderGuidance):
    pass


class Jurisdiction151(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance144(RenderGuidance):
    pass


class Jurisdiction152(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance145(RenderGuidance):
    pass


class Jurisdiction153(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method24, Field(description='Authentication method', title='Webhook Security Method')
    ]
...
class RenderGuidance146(RenderGuidance):
    pass


class Jurisdiction154(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance147(RenderGuidance):
    pass


class Jurisdiction155(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance148(RenderGuidance):
    pass


class Jurisdiction156(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance149(RenderGuidance):
    pass


class Jurisdiction157(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction158(RootModel[str]):
    root: Annotated[str, Field(pattern='^[A-Z]{2}(-[A-Z0-9]{1,3})?$')]
...
class RenderGuidance150(RenderGuidance):
    pass


class Jurisdiction159(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
