...
class Suppress19(Suppress):
    pass


class Window30(Suppress):
    pass
...
class Suppress20(Suppress):
    pass


class Window31(Suppress):
    pass
...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit128, Field(description='Time unit.')]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit129, Field(description='Distance unit.', title='Distance Unit')]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type107, Field(description='GeoJSON geometry type.')]
...
class TargetingOverlay(AdCPBaseModel):
    ...
    frequency_cap: Annotated[
        FrequencyCap | FrequencyCap19 | FrequencyCap20 | None,
        Field(
    ...
    geo_proximity: Annotated[
        list[GeoProximity | GeoProximity27 | GeoProximity28] | None,
        Field(
