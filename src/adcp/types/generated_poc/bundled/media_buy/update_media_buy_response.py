...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit144, Field(description="Time unit.")]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit145, Field(description="Distance unit.", title="Distance Unit")]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type110, Field(description="GeoJSON geometry type.")]
