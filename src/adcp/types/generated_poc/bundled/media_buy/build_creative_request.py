...
class RenderGuidance1(RenderGuidance):
    pass


class Jurisdiction1(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance2(RenderGuidance):
    pass
...
class RenderGuidance3(RenderGuidance):
    pass


class Jurisdiction3(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance4(RenderGuidance):
    pass


class Jurisdiction4(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance5(RenderGuidance):
    pass


class Jurisdiction5(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance6(RenderGuidance):
    pass


class Jurisdiction6(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance7(RenderGuidance):
    pass


class Jurisdiction7(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance8(RenderGuidance):
    pass


class Jurisdiction8(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance9(RenderGuidance):
    pass


class Jurisdiction9(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance10(RenderGuidance):
    pass


class Jurisdiction10(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance11(RenderGuidance):
    pass


class Jurisdiction11(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance12(RenderGuidance):
    pass


class Jurisdiction12(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance13(RenderGuidance):
    pass


class Jurisdiction14(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
