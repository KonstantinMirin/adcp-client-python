...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit116, Field(description="Time unit.")]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit117, Field(description="Distance unit.", title="Distance Unit")]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type98, Field(description="GeoJSON geometry type.")]
...
class GeoMetro6(GeoMetro):
    pass


class GeoMetrosExcludeItem6(GeoMetrosExcludeItem):
    pass


class GeoPostalArea6(GeoPostalArea):
    pass


class GeoPostalAreasExcludeItem6(GeoPostalAreasExcludeItem):
    pass


class DaypartTarget6(DaypartTarget):
    pass
...
class AgeRestriction8(AgeRestriction):
    pass


class TravelTime25(TravelTime):
    pass


class Radius25(Radius):
    pass
...
class TravelTime26(TravelTime):
    pass


class Radius26(Radius):
    pass
...
class TravelTime27(TravelTime):
    pass


class Radius27(Radius):
    pass
...
class KeywordTarget6(KeywordTarget):
    pass


class NegativeKeyword6(NegativeKeyword):
    pass
...
class TargetingOverlay5(AdCPBaseModel):
    ...
    geo_metros_exclude: Annotated[
        list[GeoMetrosExcludeItem6] | None,
        Field(
            description="Exclude specific metro areas from delivery. Each entry specifies the classification system and excluded values. Seller must declare supported systems in get_adcp_capabilities.",
            min_length=1,
        ),
    ...
    geo_postal_areas_exclude: Annotated[
        list[GeoPostalAreasExcludeItem6] | None,
        Field(
            description="Exclude specific postal areas from delivery. Each entry specifies the postal system and excluded values. Seller must declare supported systems in get_adcp_capabilities.",
            min_length=1,
        ),
