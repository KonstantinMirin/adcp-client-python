...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit100, Field(description='Time unit.')]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit101, Field(description='Distance unit.', title='Distance Unit')]
...
class Geometry(AdCPBaseModel):
    ...
    type: Annotated[Type95, Field(description='GeoJSON geometry type.')]
...
class TravelTime20(TravelTime):
    pass


class Radius20(Radius):
    pass
...
class TravelTime21(TravelTime):
    pass


class Radius21(Radius):
    pass
...
class RenderGuidance219(RenderGuidance):
    pass


class Jurisdiction232(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance220(RenderGuidance):
    pass


class Jurisdiction233(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Assets319(AdCPBaseModel):
    ...
    channels: Annotated[AudioChannels | None, Field(description='Channel configuration')] = None
...
class RenderGuidance221(RenderGuidance):
    pass


class Jurisdiction234(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance222(RenderGuidance):
    pass


class Jurisdiction235(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance223(RenderGuidance):
    pass


class Jurisdiction236(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance224(RenderGuidance):
    pass


class Jurisdiction237(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance225(RenderGuidance):
    pass


class Jurisdiction238(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance226(RenderGuidance):
    pass


class Jurisdiction239(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method34, Field(description='Authentication method', title='Webhook Security Method')
    ]
...
class RenderGuidance227(RenderGuidance):
    pass


class Jurisdiction240(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance228(RenderGuidance):
    pass


class Jurisdiction241(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance229(RenderGuidance):
    pass


class Jurisdiction242(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance230(RenderGuidance):
    pass


class Jurisdiction243(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction244(RootModel[str]):
    root: Annotated[str, Field(pattern='^[A-Z]{2}(-[A-Z0-9]{1,3})?$')]
...
class RenderGuidance231(RenderGuidance):
    pass


class Jurisdiction245(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class EventSource9(EventSource):
    pass
...
class GeoMetro5(GeoMetro):
    pass


class GeoMetrosExcludeItem5(GeoMetrosExcludeItem):
    pass


class GeoPostalArea5(GeoPostalArea):
    pass


class GeoPostalAreasExcludeItem5(GeoPostalAreasExcludeItem):
    pass


class DaypartTarget5(DaypartTarget):
    pass


class Suppress15(Window):
    pass
...
class FrequencyCap15(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    suppress: Annotated[
...
class AgeRestriction7(AgeRestriction):
    pass


class TravelTime22(TravelTime):
    pass


class Radius22(Radius):
    pass


class Geometry22(Geometry):
    pass


class GeoProximity23(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    lat: Annotated[
...
class TravelTime23(TravelTime):
    pass


class Radius23(Radius):
    pass
...
class TravelTime24(TravelTime):
    pass


class Radius24(Radius):
    pass
...
class KeywordTarget5(KeywordTarget):
    pass


class NegativeKeyword5(NegativeKeyword):
    pass


class TargetingOverlay4(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    geo_countries: Annotated[
    ...
    geo_metros_exclude: Annotated[
        list[GeoMetrosExcludeItem5] | None,
        Field(
            description='Exclude specific metro areas from delivery. Each entry specifies the classification system and excluded values. Seller must declare supported systems in get_adcp_capabilities.',
            min_length=1,
        ),
    ...
    geo_postal_areas_exclude: Annotated[
        list[GeoPostalAreasExcludeItem5] | None,
        Field(
            description='Exclude specific postal areas from delivery. Each entry specifies the postal system and excluded values. Seller must declare supported systems in get_adcp_capabilities.',
            min_length=1,
        ),
    ...
    frequency_cap: Annotated[
        FrequencyCap15 | FrequencyCap16 | FrequencyCap17 | None,
        Field(
            description='Frequency capping settings for package-level application. Two types of frequency control can be used independently or together: suppress enforces a cooldown between consecutive exposures; max_impressions + per + window caps total exposures per entity in a time window. When both suppress and max_impressions are set, an impression is delivered only if both constraints permit it (AND semantics). At least one of suppress, suppress_minutes, or max_impressions must be set.',
            title='Frequency Cap',
        ),
    ...
    geo_proximity: Annotated[
        list[GeoProximity23 | GeoProximity24 | GeoProximity25] | None,
        Field(
            description='Target users within travel time, distance, or a custom boundary around arbitrary geographic points. Multiple entries use OR semantics — a user within range of any listed point is eligible. For campaigns targeting 10+ locations, consider using store_catchments with a location catalog instead. Seller must declare support in get_adcp_capabilities.',
            min_length=1,
        ),
...
class RenderGuidance232(RenderGuidance):
    pass


class Jurisdiction246(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance233(RenderGuidance):
    pass


class Jurisdiction247(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance234(RenderGuidance):
    pass


class Jurisdiction248(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance235(RenderGuidance):
    pass


class Jurisdiction249(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance236(RenderGuidance):
    pass


class Jurisdiction250(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance237(RenderGuidance):
    pass


class Jurisdiction251(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance238(RenderGuidance):
    pass


class Jurisdiction252(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance239(RenderGuidance):
    pass


class Jurisdiction253(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance240(RenderGuidance):
    pass


class Jurisdiction254(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance241(RenderGuidance):
    pass


class Jurisdiction255(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Assets342(AdCPBaseModel):
    ...
    security: Annotated[Security13, Field(description='Security configuration for webhook calls')]
    provenance: Annotated[
        Provenance241 | None,
        Field(
            description='Provenance metadata for this asset, overrides manifest-level provenance',
...
class RenderGuidance242(RenderGuidance):
    pass


class Jurisdiction256(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance243(RenderGuidance):
    pass


class Jurisdiction257(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance244(RenderGuidance):
    pass


class Jurisdiction258(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction259(Jurisdiction244):
    pass


class RequiredDisclosure14(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    text: Annotated[str, Field(description='The disclosure text that must appear in the creative')]
...
class IndustryIdentifier12(IndustryIdentifier):
    pass
...
class RenderGuidance245(RenderGuidance):
    pass


class Jurisdiction260(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Creative12(AdCPBaseModel):
    ...
    industry_identifiers: Annotated[
        list[IndustryIdentifier12] | None,
        Field(
            description='Industry-standard identifiers for this creative (e.g., Ad-ID, ISCI, Clearcast clock number). In broadcast buying, these identifiers tie the creative to rotation instructions and traffic systems. A creative may have multiple identifiers when different systems reference the same asset.'
        ),
    ] = None
...
class Authentication10(Authentication):
    pass
