...
class TravelTime(AdCPBaseModel):
    ...
    unit: Annotated[Unit11, Field(description="Time unit.")]
...
class Radius(AdCPBaseModel):
    ...
    unit: Annotated[Unit12, Field(description="Distance unit.", title="Distance Unit")]
...
class RenderGuidance58(RenderGuidance):
    pass


class Jurisdiction61(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance59(RenderGuidance):
    pass


class Jurisdiction62(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance60(RenderGuidance):
    pass


class Jurisdiction63(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance61(RenderGuidance):
    pass


class Jurisdiction64(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance62(RenderGuidance):
    pass


class Jurisdiction65(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance63(RenderGuidance):
    pass


class Jurisdiction66(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance64(RenderGuidance):
    pass


class Jurisdiction67(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance65(RenderGuidance):
    pass


class Jurisdiction68(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance66(RenderGuidance):
    pass


class Jurisdiction69(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance67(RenderGuidance):
    pass


class Jurisdiction70(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance68(RenderGuidance):
    pass


class Jurisdiction71(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance69(RenderGuidance):
    pass


class Jurisdiction72(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Jurisdiction73(RootModel[str]):
    root: Annotated[str, Field(pattern="^[A-Z]{2}(-[A-Z0-9]{1,3})?$")]
...
class RenderGuidance70(RenderGuidance):
    pass


class Jurisdiction74(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Authentication3(Authentication2):
    pass
