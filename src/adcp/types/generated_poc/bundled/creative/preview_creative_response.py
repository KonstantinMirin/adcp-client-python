...
class Results3(AdCPBaseModel):
    ...
    errors: Annotated[list[Error22], Field(description='Errors for failed requests', min_length=1)]
...
class RenderGuidance180(RenderGuidance):
    pass


class Jurisdiction191(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance181(RenderGuidance):
    pass


class Jurisdiction192(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance182(RenderGuidance):
    pass


class Jurisdiction193(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance183(RenderGuidance):
    pass


class Jurisdiction194(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance184(RenderGuidance):
    pass


class Jurisdiction195(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance185(RenderGuidance):
    pass
...
class RenderGuidance186(RenderGuidance):
    pass


class Jurisdiction197(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance187(RenderGuidance):
    pass


class Jurisdiction198(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method30, Field(description='Authentication method', title='Webhook Security Method')
    ]
...
class RenderGuidance188(RenderGuidance):
    pass


class Jurisdiction199(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance189(RenderGuidance):
    pass


class Jurisdiction200(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance190(RenderGuidance):
    pass


class Jurisdiction201(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance191(RenderGuidance):
    pass


class Jurisdiction202(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction203(RootModel[str]):
...
class RenderGuidance192(RenderGuidance):
    pass


class Jurisdiction204(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
