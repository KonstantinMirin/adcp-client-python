...
class RenderGuidance152(RenderGuidance):
    pass


class Jurisdiction161(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance153(RenderGuidance):
    pass


class Jurisdiction162(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance154(RenderGuidance):
    pass


class Jurisdiction163(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance155(RenderGuidance):
    pass


class Jurisdiction164(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance156(RenderGuidance):
    pass


class Jurisdiction165(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance157(RenderGuidance):
    pass


class Jurisdiction166(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance158(RenderGuidance):
    pass


class Jurisdiction167(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance159(RenderGuidance):
    pass


class Jurisdiction168(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method26, Field(description="Authentication method", title="Webhook Security Method")
    ]
...
class RenderGuidance160(RenderGuidance):
    pass


class Jurisdiction169(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance161(RenderGuidance):
    pass


class Jurisdiction170(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance162(RenderGuidance):
    pass


class Jurisdiction171(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance163(RenderGuidance):
    pass


class Jurisdiction172(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Jurisdiction173(RootModel[str]):
...
class RenderGuidance164(RenderGuidance):
    pass


class Jurisdiction174(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance165(RenderGuidance):
    pass


class Jurisdiction175(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance166(RenderGuidance):
    pass


class Jurisdiction176(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance167(RenderGuidance):
    pass


class Jurisdiction177(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance168(RenderGuidance):
    pass


class Jurisdiction178(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance169(RenderGuidance):
    pass


class Jurisdiction179(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance170(RenderGuidance):
    pass


class Jurisdiction180(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance171(RenderGuidance):
    pass


class Jurisdiction181(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance172(RenderGuidance):
    pass


class Jurisdiction182(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance173(RenderGuidance):
    pass


class Jurisdiction183(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance174(RenderGuidance):
    pass


class Jurisdiction184(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Assets270(AdCPBaseModel):
    ...
    security: Annotated[Security9, Field(description="Security configuration for webhook calls")]
    provenance: Annotated[
        Provenance175 | None,
        Field(
            description="Provenance metadata for this asset, overrides manifest-level provenance",
...
class RenderGuidance175(RenderGuidance):
    pass


class Jurisdiction185(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance176(RenderGuidance):
    pass


class Jurisdiction186(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance177(RenderGuidance):
    pass


class Jurisdiction187(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Jurisdiction188(Jurisdiction173):
    pass


class RequiredDisclosure10(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    text: Annotated[str, Field(description="The disclosure text that must appear in the creative")]
...
class IndustryIdentifier8(IndustryIdentifier):
    pass
...
class RenderGuidance178(RenderGuidance):
    pass


class Jurisdiction189(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
