...
class ByEventTypeItem(AdCPBaseModel):
    ...
    event_type: Annotated[EventType, Field(description="The event type", title="Event Type")]
...
class ByActionSourceItem(AdCPBaseModel):
    ...
    action_source: Annotated[
        ActionSource, Field(description="Where the conversion occurred", title="Action Source")
    ]
    event_source_id: Annotated[
        str | None,
        Field(
...
class ByEventTypeItem2(ByEventTypeItem):
    pass
...
class Viewability2(Viewability):
    pass


class ByActionSourceItem2(ByActionSourceItem):
    pass
...
class RenderGuidance82(RenderGuidance):
    pass


class Jurisdiction87(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance83(RenderGuidance):
    pass


class Jurisdiction88(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance84(RenderGuidance):
    pass


class Jurisdiction89(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance85(RenderGuidance):
    pass


class Jurisdiction90(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance86(RenderGuidance):
    pass


class Jurisdiction91(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance87(RenderGuidance):
    pass


class Jurisdiction92(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance88(RenderGuidance):
    pass


class Jurisdiction93(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance89(RenderGuidance):
    pass


class Jurisdiction94(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method9, Field(description="Authentication method", title="Webhook Security Method")
    ]
...
class RenderGuidance90(RenderGuidance):
    pass


class Jurisdiction95(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance91(RenderGuidance):
    pass


class Jurisdiction96(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance92(RenderGuidance):
    pass


class Jurisdiction97(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class RenderGuidance93(RenderGuidance):
    pass


class Jurisdiction98(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Jurisdiction99(RootModel[str]):
...
class RenderGuidance94(RenderGuidance):
    pass


class Jurisdiction100(AdCPBaseModel):
    model_config = ConfigDict(
        extra="allow",
    )
    country: Annotated[
...
class Creative(AdCPBaseModel):
    ...
    format_id: Annotated[
        FormatId | None, Field(description="Format of this creative", title="Format ID")
    ] = None
    totals: Annotated[
        Totals | None,
        Field(
