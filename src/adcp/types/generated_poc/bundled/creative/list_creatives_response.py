...
class RenderGuidance125(RenderGuidance):
    pass


class Jurisdiction132(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance126(RenderGuidance):
    pass


class Jurisdiction133(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance127(RenderGuidance):
    pass


class Jurisdiction134(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance128(RenderGuidance):
    pass


class Jurisdiction135(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance129(RenderGuidance):
    pass


class Jurisdiction136(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance130(RenderGuidance):
    pass


class Jurisdiction137(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance131(RenderGuidance):
    pass


class Jurisdiction138(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance132(RenderGuidance):
    pass


class Jurisdiction139(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method22, Field(description='Authentication method', title='Webhook Security Method')
    ]
...
class RenderGuidance133(RenderGuidance):
    pass


class Jurisdiction140(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance134(RenderGuidance):
    pass


class Jurisdiction141(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance135(RenderGuidance):
    pass


class Jurisdiction142(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance136(RenderGuidance):
    pass


class Jurisdiction143(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction144(RootModel[str]):
...
class PricingOption166(PricingOption161, PricingOption165):
    pass


class PricingOption167(PricingOption162, PricingOption165):
    pass


class PricingOption168(PricingOption163, PricingOption165):
    pass


class PricingOption169(PricingOption164, PricingOption165):
    pass


class PricingOption(
    RootModel[PricingOption166 | PricingOption167 | PricingOption168 | PricingOption169]
):
    root: Annotated[
        PricingOption166 | PricingOption167 | PricingOption168 | PricingOption169,
        Field(
