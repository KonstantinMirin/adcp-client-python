...
class Requirements27(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    min_duration_ms: Annotated[
...
class AssetRequirements15(Requirements27):
    pass
...
class Requirements40(Requirements27):
    pass
...
class SupportedDisclosurePosition(Enum):
    prominent = 'prominent'
    footer = 'footer'
    audio = 'audio'
    subtitle = 'subtitle'
...
class DisclosureCapability(AdCPBaseModel):
    ...
    position: Annotated[
        ...
        Field(description='The disclosure position', title='Disclosure Position'),
    ]
...
class PricingOption156(PricingOption151, PricingOption155):
    pass


class PricingOption157(PricingOption152, PricingOption155):
    pass


class PricingOption158(PricingOption153, PricingOption155):
    pass


class PricingOption159(PricingOption154, PricingOption155):
    pass


class PricingOption(
    RootModel[PricingOption156 | PricingOption157 | PricingOption158 | PricingOption159]
):
    root: Annotated[
        PricingOption156 | PricingOption157 | PricingOption158 | PricingOption159,
        Field(
...
class BaseGroupAsset(RootModel[Any]):
    root: Any


class BaseIndividualAsset(BaseGroupAsset):
    pass


class AssetPoolBinding(BaseGroupAsset):
    pass


class ScalarBinding(BaseGroupAsset):
    pass
...
class Format12(AdCPBaseModel):
    ...
    supported_disclosure_positions: Annotated[
        list[SupportedDisclosurePosition] | None,
        Field(
