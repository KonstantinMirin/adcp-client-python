...
class RenderGuidance195(RenderGuidance):
    pass


class Jurisdiction207(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance196(RenderGuidance):
    pass


class Jurisdiction208(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance197(RenderGuidance):
    pass


class Jurisdiction209(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance198(RenderGuidance):
    pass


class Jurisdiction210(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance199(RenderGuidance):
    pass


class Jurisdiction211(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance200(RenderGuidance):
    pass


class Jurisdiction212(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance201(RenderGuidance):
    pass


class Jurisdiction213(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance202(RenderGuidance):
    pass


class Jurisdiction214(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method32, Field(description='Authentication method', title='Webhook Security Method')
    ]
...
class RenderGuidance203(RenderGuidance):
    pass


class Jurisdiction215(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance204(RenderGuidance):
    pass


class Jurisdiction216(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance205(RenderGuidance):
    pass


class Jurisdiction217(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance206(RenderGuidance):
    pass
...
class Jurisdiction219(RootModel[str]):
...
class RenderGuidance207(RenderGuidance):
    pass
