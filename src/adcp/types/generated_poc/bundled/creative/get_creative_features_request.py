...
class RenderGuidance96(RenderGuidance):
    pass


class Jurisdiction102(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance97(RenderGuidance):
    pass


class Jurisdiction103(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance98(RenderGuidance):
    pass


class Jurisdiction104(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance99(RenderGuidance):
    pass


class Jurisdiction105(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance100(RenderGuidance):
    pass


class Jurisdiction106(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance101(RenderGuidance):
    pass
...
class RenderGuidance102(RenderGuidance):
    pass


class Jurisdiction108(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance103(RenderGuidance):
    pass


class Jurisdiction109(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Security(AdCPBaseModel):
    method: Annotated[
        Method11, Field(description='Authentication method', title='Webhook Security Method')
    ]
...
class RenderGuidance104(RenderGuidance):
    pass


class Jurisdiction110(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance105(RenderGuidance):
    pass


class Jurisdiction111(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance106(RenderGuidance):
    pass


class Jurisdiction112(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance107(RenderGuidance):
    pass


class Jurisdiction113(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class Jurisdiction114(RootModel[str]):
...
class RenderGuidance108(RenderGuidance):
    pass


class Jurisdiction115(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
