...
class RenderGuidance247(RenderGuidance):
    pass


class Jurisdiction262(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance248(RenderGuidance):
    pass


class Jurisdiction263(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance249(RenderGuidance):
    pass


class Jurisdiction264(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance250(RenderGuidance):
    pass


class Jurisdiction265(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
