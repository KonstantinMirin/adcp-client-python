...
class RenderGuidance209(RenderGuidance):
    pass
...
class RenderGuidance210(RenderGuidance):
    pass
...
class RenderGuidance211(RenderGuidance):
    pass


class Jurisdiction224(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance212(RenderGuidance):
    pass
...
class RenderGuidance213(RenderGuidance):
    pass


class Jurisdiction226(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance214(RenderGuidance):
    pass


class Jurisdiction227(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance215(RenderGuidance):
    pass


class Jurisdiction228(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance216(RenderGuidance):
    pass


class Jurisdiction229(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance217(RenderGuidance):
    pass


class Jurisdiction230(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
