...
class RenderGuidance72(RenderGuidance):
    pass


class Jurisdiction77(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance73(RenderGuidance):
    pass


class Jurisdiction78(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance74(RenderGuidance):
    pass


class Jurisdiction79(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance75(RenderGuidance):
    pass


class Jurisdiction80(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance76(RenderGuidance):
    pass


class Jurisdiction81(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance77(RenderGuidance):
    pass


class Jurisdiction82(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance78(RenderGuidance):
    pass


class Jurisdiction83(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance79(RenderGuidance):
    pass


class Jurisdiction84(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance80(RenderGuidance):
    pass


class Jurisdiction85(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class PricingOption101(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    model: Literal['cpm']
...
class PricingOption102(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption103(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption104(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption105(AdCPBaseModel):
...
class PricingOption106(PricingOption101, PricingOption105):
    pass


class PricingOption107(PricingOption102, PricingOption105):
    pass


class PricingOption108(PricingOption103, PricingOption105):
    pass


class PricingOption109(PricingOption104, PricingOption105):
    pass


class PricingOption(
    RootModel[PricingOption106 | PricingOption107 | PricingOption108 | PricingOption109]
):
    root: Annotated[
        PricingOption106 | PricingOption107 | PricingOption108 | PricingOption109,
        Field(
...
class AssetAccess(RootModel[Any]):
    root: Any


class Exemplar(AssetAccess):
    pass
...
class Policy(AdCPBaseModel):
    ...
    source: Annotated[
        Source | None,
        Field(
            description="Origin of this policy. 'registry' = published to the shared AdCP policy registry with full regulatory metadata. 'inline' = authored bespoke for a specific standards configuration, plan, or portfolio. Defaults to 'inline'. Governance agents MUST set 'registry' when publishing to the registry."
        ),
    ] = Source.inline
    version: Annotated[
        str | None,
