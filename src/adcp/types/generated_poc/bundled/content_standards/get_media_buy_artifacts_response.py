...
class RenderGuidance110(RenderGuidance):
    pass


class Jurisdiction117(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance111(RenderGuidance):
    pass


class Jurisdiction118(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance112(RenderGuidance):
    pass


class Jurisdiction119(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance113(RenderGuidance):
    pass


class Jurisdiction120(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
