...
class RenderGuidance43(RenderGuidance):
    pass


class Jurisdiction46(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance44(RenderGuidance):
    pass


class Jurisdiction47(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance45(RenderGuidance):
    pass


class Jurisdiction48(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
...
class RenderGuidance46(RenderGuidance):
    pass


class Jurisdiction49(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    country: Annotated[
