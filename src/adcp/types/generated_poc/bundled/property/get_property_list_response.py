...
class PricingOption111(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    model: Literal['cpm']
...
class PricingOption112(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption113(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption114(AdCPBaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
...
class PricingOption115(AdCPBaseModel):
...
class PricingOption116(PricingOption111, PricingOption115):
    pass


class PricingOption117(PricingOption112, PricingOption115):
    pass


class PricingOption118(PricingOption113, PricingOption115):
    pass


class PricingOption119(PricingOption114, PricingOption115):
    pass


class PricingOption(
    RootModel[PricingOption116 | PricingOption117 | PricingOption118 | PricingOption119]
):
    root: Annotated[
        PricingOption116 | PricingOption117 | PricingOption118 | PricingOption119,
        Field(
